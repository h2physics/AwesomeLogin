...
public class Rotate extends Transition {
    ...
    @Override
    public void captureStartValues(com.transitionseverywhere.TransitionValues transitionValues) {
        transitionValues.values.put(PROPNAME_ROTATION, startAngle);
    }
    @Override
    public void captureEndValues(com.transitionseverywhere.TransitionValues transitionValues) {
        transitionValues.values.put(PROPNAME_ROTATION, endAngle);
    }
    @Override
    public Animator createAnimator(ViewGroup sceneRoot, com.transitionseverywhere.TransitionValues startValues,
                                   com.transitionseverywhere.TransitionValues endValues) {
